...
namespace Unity.Multiplayer.Center.NetcodeForEntitiesSetup
{
    ...
    public partial struct GoInGameServerSystem : ISystem 
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var spawnPT = GetSpawnPoint();
            
            var spawnPos = spawnPointsLtsWs[spawnPT].Position;
            var spawnRot = spawnPointsLtsWs[spawnPT].Rotation;
                     ...
                     SystemAPI.Query<RefRO<ReceiveRpcCommandRequest>>().WithAll<GoInGameRequest>().WithEntityAccess())
            {
                ...
                commandBuffer.SetComponent(player, LocalTransform.FromPositionRotation(spawnPos, spawnRot));
        ...
        private int GetSpawnPoint()
        {
            ...
            {
                selectedSpawnPoint = currentSpawnPoint;
                currentSpawnPoint = 1;
            }
            else
            {
            ...
            Debug.Log("SPAWNING AT POS: " + selectedSpawnPoint);
